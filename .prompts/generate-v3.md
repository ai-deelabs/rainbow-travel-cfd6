...
Brand:
Rainbow Travel เป็นธุรกิจเกี่ยวกับทัวร์ที่เน้นการขายทัวร์และแสดงแพ็คเกจทัวร์ต่างๆ โทนสีเน้นสีฟ้า-น้ำเงินสดใส มีโลโก้รูปสายรุ้งกับเครื่องบิน และมีปุ่ม CTA สีเหลือง ใช้ภาพวิวทะเลและสถานที่ท่องเที่ยวต่างๆ

This is variant 3 of 3.

CREATIVE DIRECTION
A creative director has chosen this direction for variant #3:
dense asymmetric editorial grid borrowed from 1990s travel magazine double-spreads — floating text blocks at opposing angles, destination names as massive background watermarks — humanist slab serif (Zilla Slab Bold) for headers colliding with handwritten-style connective type — vivid editorial five-color split: cloud white #F7F9FC (60%) + sky iris #4F6FE8 (30%) + signal yellow #FFD300 (7%) + coral reef #FF5C39 + rainbow arc gradient used only as a 2px rule/divider — nostalgic, abundant, like a JAL Airways brochure from 1987 Osaka
